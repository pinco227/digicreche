...
- ### Issues found while testing:
  ...
  - Load more button for chat and activities not working
  - **FIXED&**: this was caused by sending API requests to unsecure http endpoint from a https connection. The endpoints for this particular functionality are generated by Django Rest Framework and are given as next property of response when pagination is activated for an API endpoint. Fixed by splitting the url and calling the relative path instead.
...
> :heavy_check_mark:
>
>   ![LightHouse Performance Result for Landing page](https://github.com/pinco227/digicreche/blob/main/docs/perf.png)  
